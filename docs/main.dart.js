...
return null},
dG(){var s,r,q,p,o,n,m,l,k,j=this,i="_state",h="container",g="columns is-mobile",f="column has-text-centered",e="column",d=t.s,c=A.b([],d),b=j.fx.c
if(b===$)A.S(i)
b=b.aI()
...
B.a.m(c,b)}b=j.fx.c
if(b===$)A.S(i)
if(!b.y&&j.cT().length>0){b=A.a6()
b.e.i(0,11,"container round-dice")
s=j.fx.c
if(s===$)A.S(i)
s=""+s.b.length+"-"+s.d.a.length
b.c=s
b.e.i(0,12,s)
s=A.a6()
s.e.i(0,11,g)
...
r.e.i(0,11,f)
q=A.a6()
q.e.i(0,11,"notification dice-area")
p=t.x
o=p.a(j.cT())
o=A.b(o.slice(0),A.w(o))
q.sp(0,o)
...
B.a.m(c,b)}b=j.fx.c
if(b===$)A.S(i)
b=b.d.a.length!==0||b.f.length!==0||b.c.length!==0
s=t.x
if(b){b=A.a6()
b.e.i(0,11,"container round-history")
r=A.a6()
r.e.i(0,11,g)
q=A.a6()
q.e.i(0,11,e)
...
r=A.b(r.slice(0),A.w(r))
b.sp(0,r)
B.a.m(c,b)}else{b=A.a6()
b.e.i(0,11,h)
r=t.e
q=t.z
p=A.r(r,q)
o=t.u
n=new A.fE(p,A.r(r,q),A.r(r,o),A.b([],d))
p.i(0,11,"table is-fullwidth")
o=new A.fF(A.r(r,q),A.r(r,q),A.r(r,o),A.b([],d))
r=s.a(j.eF())
r=A.b(r.slice(0),A.w(r))
o.sp(0,r)
r=s.a(A.b([o],d))
...
p=t.z
o=A.r(q,p)
q=new A.fD(o,A.r(q,p),A.r(q,t.u),A.b([],d))
o.i(0,11,"section")
s.a(c)
p=A.b(c.slice(0),A.w(c))
q.sp(0,p)
d=s.a(A.b([r,q],d))
